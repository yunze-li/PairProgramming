...
/** Base [ViewModel] for our other [ViewModel] implementations. */
abstract class BaseViewModel : ViewModel /* splinter ignore */() {
  ...
  @UiThread fun Disposable.unsubscribeOnCleared(): Unit = addCloseable { this.dispose() }
