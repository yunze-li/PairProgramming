...
/**
 * Base fragment for all of our [BottomSheetDialogFragment] classes.
 *
 * Usage:
 * ```
 * class SomeFragment : MvvmBottomSheetDialogFragment<SomeBinding>(SomeBinding::inflate) {
 ...
 * ```
 */
abstract class MvvmBottomSheetDialogFragment<VB : ViewBinding>(
  private val bindingInflate: (LayoutInflater, ViewGroup?, Boolean) -> VB
) : BottomSheetDialogFragment(), MvvmView {
